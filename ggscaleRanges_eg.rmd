...
ggscaleRanges makes ggplot2 coordinate transformations from GRanges or IRanges objects in one line of code. These can be used to make static ggplot2 or ggbio plots of data from genes or genomic regions.
